...
void printQuestion() {
  ...
  char *buffer = "";    // make sure this is large enough for the largest string it must hold
  int cual = random(202);
...
//    translate(&question, (int) random(5));
  ...
  char* line;    // make sure this is large enough for the largest string it must hold
  char* wor;
  ...
  while (wor != NULL)
  {    
    int qty = strlen(line) + strlen(wor); // cuan largo será...
    Serial.println(wor);
